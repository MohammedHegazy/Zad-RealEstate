...
Route::prefix('investment-analyses')->name('investment-analyses.')->group($analysisRoutes);

Route::prefix('my/investment-analyses')->name('my.investment-analyses.')->group($analysisRoutes);
