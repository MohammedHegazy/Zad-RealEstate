...
Route::prefix('estates')->name('estates.')->group(function () {
    ...
    Route::post('/', [EstateController::class, 'store'])->name('store');
    Route::get('{estate}', [EstateController::class, 'show'])->name('show');
    Route::put('{estate}', [EstateController::class, 'update'])->name('update');
    Route::post('{estate}', [EstateController::class, 'update'])->name('update-media');
