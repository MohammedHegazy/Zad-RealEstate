...
Route::put('my/estates/{estate}', [EstateController::class, 'update'])->name('my.estates.update');
Route::delete('my/estates/{estate}', [EstateController::class, 'destroy'])->name('my.estates.destroy');
Route::put('my/estates/{estate}/social-media', [SocialMediaController::class, 'updateEstateLinks'])
